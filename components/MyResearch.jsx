    ...
    <div id="research" className="w-full">
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <p>
          ...
          <h3 className = "py-4">{"Electrical/Computer Engineering Undergraduate Research"}</h3>
          ...
          <h3 className = "py-4">{"Fire Rover: Programming and Documentation Lead"}</h3>
          ...
          <h3 className = "py-4">{"Mesocast.net Team Member"}</h3>
          ...
          <h3 className = "py-4">{"Increasing knowledge through University"}</h3>
