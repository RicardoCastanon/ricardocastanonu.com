    ...
    <div id="research" className="w-full">
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <p>
          ...
          architecture in embedded systems. Additionally, I am increasing my knowledge
          on robotics programming and Arduino through being the Programming Lead in my
          Senior Design Project, Fire Rover. This project consists of creating a 
          Unmanned Ground Vehicle (UGV) used to lay heavy hose in long-distance, rugged
          terrain with obstacles. Its objective will be to reduce firefighter injury
          and fatigue during the weeks after wildfires are extinguished. Furthermore, 
          working in the Development Team of Mesocast.net, I am working alongside skilled 
